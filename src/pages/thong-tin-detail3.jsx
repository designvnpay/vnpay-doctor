...
const ThongTinDetail3 = () => (
            <Page name="ThongTinDetail3" className='thong-tin-detail bg-white'>
                <Navbar backLink="Back" title='Thông tin người thân'></Navbar>
        ...
        <Button onClick={notify_delete} className='col' fill href="#" color="danger"><Icon icon="icon24 icons-ic24px-delete filter-danger"></Icon> <span className='button-txt'>Xóa</span></Button>
            ...
            <Button className='col' fill href="/thong-tin-nguoi-than/"><Icon icon="icon24 icons-ic24px-edit filter-white"></Icon> <span className='button-txt'>Sửa</span></Button>
            </Col>
        </Row>
  </Toolbar>
      ...
      <Col width="30" className='badge-small'><span className="badge color-warning">Con</span></Col>
      </CardHeader>
      <CardContent>
...
export default ThongTinDetail3;