...
const PhonebookPage = () => (
  <Page name="PhonebookPage" className='phonebookpage'>
    {/* Top Navbar */}
    <Navbar large sliding={false}>
      <NavLeft>
        <Link iconIos="f7:menu" iconAurora="f7:menu" iconMd="material:menu" panelOpen="left" />
      </NavLeft>
      <NavTitle sliding>PhonebookPage</NavTitle>
      <NavTitleLarge>PhonebookPage</NavTitleLarge>
    </Navbar>
    ...
    <Link className='icons-tab icons-tab4' tabLink="#view-phonebook" tabLinkActive iconIos="icons-tab4" text="Danh bạ" />
  </Toolbar>
