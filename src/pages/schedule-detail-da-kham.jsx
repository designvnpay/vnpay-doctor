...
import {
  ...
  export default () => {
    ...
    return (
      <Page name="SchedulePageDetailDaKham" className='schedule-detail'>
        <Navbar title="Chi tiết lịch khám " backLink="Back">
</Navbar>
<Toolbar bottom className='button-bottom'>
<Button href='/goi-kham-detail/' fill className='width-100' color="primary">Đặt lại dịch vụ</Button>
</Toolbar>
...
<List accordionList className='no-margin list-cols search-list'>
  ...
  <span className="badge color-default semibold">Đã khám 3/3</span>
</Col>
  </Row>
        <AccordionContent>
