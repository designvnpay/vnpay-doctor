...
import {
  ...
  export default () => {
    ...
    return (
      <Page name="SchedulePageDetailChoKham3" className='schedule-detail'>
...
<List accordionList className='no-margin list-cols search-list'>
  ...
  <span className="badge color-default semibold">Đã khám 0/3</span>
      ...
      <div className="timeline-item active check">
        <div className="timeline-item-divider"></div>
        <div className="timeline-item-content">
        <Button small className='justify-content-start' color="green"><Icon className='mr0' icon="icon16 icons-ic24px-check ic-mask"></Icon> <span className="font-size-12">Đã đặt lịch</span></Button>    
          <div className="timeline-item-inner">
          <div className='timeline-top'>
          ...
          25/04/2023 09:45
            ...
            <Col width={45} className='text-right'>
            <Link href='/doi-lich-kham/'><span className="color-primary">Đổi lịch khám</span> <Icon icon="icon20 icons-ic24px-arrow-right filter-primary"></Icon></Link>
            </Col>
          </Row>
          </div>            
            </div>
