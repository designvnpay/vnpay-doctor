...
const ThongTinDetail2 = () => (
            <Page name="ThongTinDetail2" className='thong-tin-detail bg-white'>
      ...
      <Col width="30" className='badge-small'><span className="badge color-danger">Vợ</span></Col>
      </CardHeader>
      <CardContent>
...
export default ThongTinDetail2;