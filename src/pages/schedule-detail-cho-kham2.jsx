...
import {
  ...
  export default () => {
    ...
    return (
      <Page name="SchedulePageDetailChoKham2" className='schedule-detail'>
...
<List accordionList className='no-margin list-cols search-list'>
      <ListItem className='accordion-item-opened' accordionItem>
  <Row slot='title' noGap>
  <Col width={60} className='white-space-normal'><div className="medium title">Liệu trình khám</div></Col>
  <Col width={40} className='col-right-auto'>
  <span className="badge color-default semibold">Đã khám 0/3</span>
</Col>
  </Row>
        <AccordionContent>
        ...
        <Button small className='justify-content-start' color="green"><Icon className='mr0' icon="icon16 icons-ic24px-check ic-mask"></Icon> <span className="font-size-12">Đã khám</span></Button>    
          <div className="timeline-item-inner">
          <div className='timeline-top'>
          <span className="badge badge-20 color-bg-danger">Buổi 1</span>
          </div>
          <div className='timeline-cont'>
          Tư vấn online trước khám
          </div>
          ...
          <Col width={55}>
            ...
            <Link href='/ket-qua-kham/'><span className="color-primary">Xem kết quả</span> <Icon icon="icon20 icons-ic24px-arrow-right filter-primary"></Icon></Link>
            </Col>
          </Row>
          </div>            
            </div>
      ...
      <div className="timeline-item active">
        ...
        <Button small className='justify-content-start' color="green"><Icon className='mr0' icon="icon16 icons-ic24px-check ic-mask"></Icon> <span className="font-size-12">Đã khám</span></Button>    
          <div className="timeline-item-inner">
          <div className='timeline-top'>
          <span className="badge badge-20 color-bg-danger">Buổi 2</span>
          </div>
          <div className='timeline-cont'>
          Tư vấn online trước khám
          </div>
      ...
      <div className="timeline-item active check">
        <div className="timeline-item-divider"></div>
        <div className="timeline-item-content">
        <Button small className='justify-content-start' color="red"><Icon className='mr0' icon="icon16 icons-ic24px-clock ic-mask"></Icon> <span className="font-size-12">Chưa có lịch khám</span></Button>    
          <div className="timeline-item-inner">
          <div className='timeline-top'>
          <span className="badge badge-20 color-bg-danger">Buổi 3</span>
          </div>
          <div className='timeline-cont'>
          Tư vấn online trước khám
          </div>
          ...
          <Row>
          <Col width={55}>
          <span className='color-disable'>Chưa có lịch khám</span>
            </Col>
            <Col width={45} className='text-right'>
            <Link href='/dat-lich-kham2/'><span className="color-primary">Đặt lịch khám</span> <Icon icon="icon20 icons-ic24px-arrow-right filter-primary"></Icon></Link>
            </Col>
          </Row>
          </div>            
            </div>
      ...
      <div className="timeline-item disable">
        <div className="timeline-item-divider"></div>
        <div className="timeline-item-content"> 
          <div className="timeline-item-inner">
          <div className='timeline-top'>
          <span className="badge badge-20 color-bg-danger">Buổi 4</span>
          </div>
          <div className='timeline-cont'>
          Tư vấn online trước khám
          </div>
