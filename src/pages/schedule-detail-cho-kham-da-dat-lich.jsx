...
import {
  ...
  export default () => {
    ...
    return (
      <Page name="SchedulePageDetailChoKhamDaDatLich" className='schedule-detail schedule-detail-toolbar'>
        <Navbar title="Chi tiết lịch khám " backLink="Back">
</Navbar>
<Toolbar bottom className='button-bottom toolbar-block'>
<Button href='/doi-lich-kham/' fill className='width-100 mb12' color="primarry">Đổi lịch khám</Button>
