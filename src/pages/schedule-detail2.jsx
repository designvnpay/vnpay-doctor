...
const SchedulePageDetail2 = () => (
            <Page name="SchedulePageDetail2" className='schedule-detail'>
                <Navbar backLink="Back" title='Chi tiết lịch khám'></Navbar>
    <Toolbar bottom className='button-bottom'>
    <Button fill className='width-100' href="/ket-qua-kham/" color="primary">Xem kết quả khám</Button>
  </Toolbar>
  ...
  <div className="toast-content align-items-start">
    ...
    <BlockTitle className='font-size-14 no-margin'>Đã khám</BlockTitle>
    </div>
  </div>
</div>  
      </Block>
...
export default SchedulePageDetail2;