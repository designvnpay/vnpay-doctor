...
const ThongTinNguoiThan = () => (
            <Page name="ThongTinNguoiThan" className='thong-tin'>
                <Navbar title="Thông tin người thân" backLink="Back">
</Navbar>
  ...
  <List className='list-form no-margin padding-top-12'>
    <ListItem className='text-no-ellipsis list-item-info'
        checkbox 
        name="my-checkbox"
        value="info-box"
        title="Sử dụng thông tin liên lạc của tôi"
      ></ListItem>
    </List>
      ...
      <ListItem className='label-mb0' title="Quan hệ" smartSelect smartSelectParams={{
            pageTitle: 'Quan hệ', openIn: 'popup',searchbar: true, searchbarPlaceholder: 'Tìm kiếm...',closeOnSelect:true,
    ...
    readonly
    calendarParams={{openIn: 'customModal', header: true, title:'Chọn', footer: true, dateFormat: 'dd MM yyyy'}}
  >
...
export default ThongTinNguoiThan;