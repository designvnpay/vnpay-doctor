...
import {
  ...
  export default () => {
    ...
    return (
      <Page name="SchedulePageDetailChoKham4" className='schedule-detail'>
...
<List accordionList className='no-margin list-cols search-list'>
  ...
  <span className="badge color-default semibold">Đã khám 0/3</span>
        ...
        <Button small className='justify-content-start' color="blue"><Icon className='mr0' icon="icon16 icons-ic24px-processing ic-mask"></Icon> <span className="font-size-12">Đang xử lý</span></Button>    
