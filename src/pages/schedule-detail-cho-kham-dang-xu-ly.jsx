  ...
  export default () => {
    ...
    const notifystep2 = () => {
      f7.dialog.create({
          ...
          closeByBackdropClick: true,
          //text: '',
          content:'<div class="icon-noty"><i class="icon icon64 icons-ic64px-status-successful"></i></div> <div class="title-noty">Thông báo</div><div class="mb24 text-noty">Hủy dịch vụ thành công</div><div class="dialog-button dialog-input-field input"><p class="row no-margin"><a class="col close-dialog button button-fill" href="#" onClick={notifystep2}><span class="button-txt">Đồng ý</span></a></p></div>',
    ...
    return (
      <Page name="SchedulePageDetailChoKhamDaQuaHan" className='schedule-detail'>
