...
const KetquaThanhtoan = () => (
  ...
  <Block className='mt10'>
      ...
      <Row className='title'><Col>Đặt khám thành công</Col></Row>
      <Row className='color-subtitle font-size-12 mb5'><Col>Tiền tạm tính thanh toán tại CSYT</Col></Row>
      <Row className='price'><Col><div className="medium color-primary font-size-20">500,000<sub>đ</sub> </div></Col></Row>
      ...
      <ListItem title="Cơ sở y tế" after="Bệnh viện hữu nghị Việt Đức"></ListItem>
