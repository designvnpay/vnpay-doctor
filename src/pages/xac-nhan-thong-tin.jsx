...
const XacNhanThongTin = () => (
        ...
        <Row className='width-100'>
            ...
            <Button href="/ket-qua-thanh-toan/" fill color="primary-light">Đặt lịch khám</Button>
            </Col>
        </Row>
  </Toolbar>
  <Block className='block-none box-white'>
      ...
      <ListItem title="Ngày tháng năm sinh" after="Bệnh viện hữu nghị Việt Đức"></ListItem>
