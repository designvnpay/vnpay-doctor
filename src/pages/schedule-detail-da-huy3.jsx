...
Subnavbar
  ...
  export default () => {
    ...
    return (
      <Page name="SchedulePageDetailDahuy3" className='schedule-detail'>
        <Navbar title="Chi tiết lịch khám " backLink="Back">
        <Subnavbar className='subnavbar-style status status-green'>
        Đã hoàn
        </Subnavbar>
</Navbar>
...
<List accordionList className='no-margin list-cols search-list'>
  ...
  <span className="badge color-default semibold">Đã khám 3/3</span>
        ...
        <div className="timeline-item-content">       
          ...
          <Row>
          <Col>
            <span className='color-disable'>25/04/2023 09:45</span>
            </Col>
          </Row>
          </div>            
            </div>
